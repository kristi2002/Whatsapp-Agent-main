...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Async fetch on mount — setState runs after the await, not synchronously
    // in the effect body, so the set-state-in-effect heuristic doesn't apply.
        ...
        <div className="px-5 py-4 border-b border-white/[0.06]">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-sm font-semibold text-white leading-tight">Max&amp;Tony Nazionale</h1>
